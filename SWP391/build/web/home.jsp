            ...
            <div class="ml-auto">
              <div class="text-right">
                <a href="login.html" class="small mr-3"
                  ><span class="icon-unlock-alt"></span> ??ng nh?p</a
                >
                <a
                  href="register.html"
                  class="small btn btn-primary px-4 py-2 rounded-0"
                  ><span class="icon-users"></span> ??ng ký</a
                >
              </div>
            </div>
          </div>
            ...
            <div class="col-12">
              <div class="owl-slide-3 owl-carousel">
                  ...
                  <figure class="thumnail">
                    <a href="/courseDetail?courseId=${course.getCourse_id()}"
                      ><img
                    ...
                    <div class="category"><h3>${course.getCategory_name()}</h3></div>
                  </figure>
