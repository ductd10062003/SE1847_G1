                                ...
                                for (let j = 0; j < item.length; j++) {
                                    if (item[j].classList.contains('matching')) {
                                        ...
                                        item[j].addEventListener('drop', function (e) {
                                            if (this.id.length > 2) {
                                                let oldId = this.id;
                                                this.id = 'matchingId' + currentTarget.id;
                                                this.innerText = currentTarget.innerText;
                                                let a = document.getElementById(oldId.substring(10, oldId.length));
                        ...
                        async function confirm(courseId) {
                            ...
                            if (count === 1 && flashcardId < total) {
                                ...
                                for (let i = 0; i < matching.length; i++) {
                                    ...
                                    if (questionId.substring(13, questionId.length) === answerId.substring(8, answerId.length)) {
