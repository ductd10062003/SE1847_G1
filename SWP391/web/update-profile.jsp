                    ...
                    <div class="p-3 py-5">
                        ...
                        <form action ="updateProfile" method="Post">
                            <div class="row mt-3">
                                ...
                                <div class="col-md-12"><label class="labels">Giới tính</label><input type="text" class="form-control" placeholder="enter gender" name="gender" value="${requestScope.users.gender}"></div>
                                <div class="col-md-12"><label class="labels">Ngày sinh</label><input type="text" class="form-control" placeholder="enter dob" name="dob" value="${requestScope.users.dob}"></div>
                                <div class="col-md-12"><label class="labels">Số điện thoại</label><input type="text" class="form-control" placeholder="enter phone" name="phone" value="${requestScope.users.phone}"></div>
                            ...
                            <button class="mt-5 text-center" type="submit">Lưu thông tin</button>
