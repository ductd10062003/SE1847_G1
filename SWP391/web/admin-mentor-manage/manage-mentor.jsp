            ...
            <div class="container">
                ...
                <form action="${pageContext.request.contextPath}/admin-mentor-manage/manage-mentor" method="post" class="mb-4">
                    <div class="row">
                        ...
                        <div class="col-md-10 form-group">
                            <input type="text" name="query" class="form-control form-control-lg" placeholder="Tìm kiếm nhân viên...">
                        </div>
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><%= mentor.getActive() == 1 ? "Hoạt động" : "Không hoạt động" %></td>
                        <td class="btn-action">
                            <% if(mentor.getActive() == 1) { %>
                            <a href="${pageContext.request.contextPath}/admin-mentor-manage/manage-mentor?action=deactivate&id=<%= mentor.getUser_id() %>" class="btn btn-danger" onclick="return confirmAction('Bạn có chắc chắn muốn ngừng kích hoạt nhân viên này không?');">Ngừng kích hoạt</a>
                            <% } else { %>
                            <a href="${pageContext.request.contextPath}/admin-mentor-manage/manage-mentor?action=activate&id=<%= mentor.getUser_id() %>" class="btn btn-primary" onclick="return confirmAction('Bạn có chắc chắn muốn kích hoạt nhân viên này không?');">Kích hoạt</a>
                            <% } %>
                        </td>
                    </tr>
                    <% } %>
