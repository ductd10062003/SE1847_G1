    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container">
                ...
                <form action="${pageContext.request.contextPath}/admin-mentor-manage/manage-student" method="post" class="mb-4">
                    <div class="row">
                        ...
                        <div class="col-md-10 form-group">
                            <input type="text" name="query" class="form-control form-control-lg" placeholder="Search for students...">
                        </div>
                ...
                <p>Note: only expert can create question in discussions</p>
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><%= student.getActive() == 1 ? "Active" : "Inactive" %></td>
