...
<%--Validate dob so that the registerer is at least 10 years old and not past 100 years old--%>
<script>
    ...
    function validate() {
        ...
        function checkUsername() {
            return new Promise((resolve, reject) => {
                ...
                xhrUsername.open("GET", "${pageContext.request.contextPath}/username-validation?username=" + encodeURIComponent(username), true);
        ...
        function checkEmail() {
            return new Promise((resolve, reject) => {
                ...
                xhrEmail.open("GET", "${pageContext.request.contextPath}/email-validation?email=" + encodeURIComponent(email), true);
