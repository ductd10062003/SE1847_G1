 ...
 * @author ductd
 */
@WebServlet(name = "multipleChoice", urlPatterns = {"/multiple-choice"})
...
//        }
        ...
        request.getRequestDispatcher("practice/multiple-choice.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (service != null) {
            switch (service) {
                case "start" -> start(request, response);
                case "result" -> result(request, response);
            }
        }
    }
